...
from openpi.core.config_manager import get_config_dir
...
def save_env_file(
    ...
    """Write env vars to ~/.openpi/.env with restricted permissions."""
    env_path = get_env_file_path(config_dir_override)

    lines = [
        "# OpenPI API Keys — generated by `openpi setup`",
