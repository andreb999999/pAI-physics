"""Read, write, and merge openpi configuration from multiple layers."""
...
DEFAULT_CONFIG_DIR = Path.home() / ".openpi"
PROJECT_CONFIG_DIR = ".openpi"
...
def load_config(config_dir_override: str | None = None) -> dict[str, Any]:
    ...
    1. Project-local .openpi/config.yaml
    2. Global ~/.openpi/config.yaml
    3. Built-in defaults
    """
