"""openpi install — install optional dependency groups."""
...
def install(extra: str) -> None:
    ...
    \b
    Examples:
      openpi install web          # Install web research deps
      openpi install all          # Install everything
    """
    ...
    if proc.returncode == 0:
        console.print(f"[green]Successfully installed {extra} dependencies.[/]")
