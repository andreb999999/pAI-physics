...
class LaTeXSyntaxCheckerToolInput(BaseModel):
    latex_input: str = Field(description="Path to .tex file or raw LaTeX content to check")
    check_level: Optional[str] = Field(default=None, description="Check level: 'basic', 'thorough', or 'strict' (default: 'thorough')")


class LaTeXSyntaxCheckerTool(BaseTool):
    model_config = ConfigDict(arbitrary_types_allowed=True)
    name: str = "latex_syntax_checker_tool"
    description: str = """
    ...
    """
    args_schema: Type[BaseModel] = LaTeXSyntaxCheckerToolInput
    ...
    def _run(self, latex_input: str, check_level: Optional[str] = None) -> str:
        """
