...
class ExperimentLinkerToolInput(BaseModel):
    source_path: str = Field(description="Full path to the experiment results folder to link/copy")
    target_name: Optional[str] = Field(default=None, description="Name for the linked folder inside paper_workspace (e.g., 'experiment_data')")


class ExperimentLinkerTool(BaseTool):
    model_config = ConfigDict(arbitrary_types_allowed=True)
    name: str = "experiment_linker_tool"
    description: str = """
    ...
    """
    args_schema: Type[BaseModel] = ExperimentLinkerToolInput
    ...
    def _run(self, source_path: str, target_name: str = "experiment_data") -> str:
        """
