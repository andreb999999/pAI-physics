...
class LaTeXContentVerificationToolInput(BaseModel):
    latex_file_path: str = Field(description="Path to the LaTeX file to verify (e.g., 'final_paper.tex')")


class LaTeXContentVerificationTool(BaseTool):
    model_config = ConfigDict(arbitrary_types_allowed=True)
    name: str = "latex_content_verification_tool"
    description: str = """
