...
class ExperimentDataOrganizerToolInput(BaseModel):
    workspace_mode: Optional[str] = Field(default=None, description="Organization mode: 'comprehensive' (default) - discovers and organizes everything")


class ExperimentDataOrganizerTool(BaseTool):
    name: str = "experiment_data_organizer_tool"
    description: str = """
    ...
    """
    args_schema: Type[BaseModel] = ExperimentDataOrganizerToolInput
    ...
    def _run(self, workspace_mode: Optional[str] = None) -> str:
