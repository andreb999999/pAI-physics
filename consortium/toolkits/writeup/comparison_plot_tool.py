...
class ComparisonPlotToolInput(BaseModel):
    comparison_specification: str = Field(description="Specification of comparison data. Can be: file paths with method data, JSON field paths (e.g., 'results.json:method1_acc,method2_acc,baseline_acc'), or description for auto-discovery")
    comparison_type: Optional[str] = Field(default=None, description="Type of comparison: 'performance_bars' (default), 'relative_improvement', 'statistical_comparison', 'distribution_comparison', 'head_to_head', 'multi_metric'")
    baseline_method: Optional[str] = Field(default=None, description="Name/identifier of the baseline method for relative comparisons (default: auto-detect)")
    statistical_testing: Optional[bool] = Field(default=None, description="Include statistical significance testing (t-tests, p-values) when multiple runs available (default: true)")
    output_filename: Optional[str] = Field(default=None, description="Output filename for the generated plot (default: auto-generated based on comparison type)")


class ComparisonPlotTool(BaseTool):
    name: str = "comparison_plot_tool"
    description: str = """
    ...
    """
    args_schema: Type[BaseModel] = ComparisonPlotToolInput
    ...
    def _run(self, comparison_specification: str, comparison_type: Optional[str] = None,
             baseline_method: Optional[str] = None, statistical_testing: Optional[bool] = None,
        ...
        if comparison_type is None:
            comparison_type = "performance_bars"
        if statistical_testing is None:
