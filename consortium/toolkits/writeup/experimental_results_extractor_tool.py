...
class ExperimentalResultsExtractorToolInput(BaseModel):
    workspace_dir: str = Field(description="Root workspace directory containing AI-Scientist runs")
    extract_mode: Optional[str] = Field(default=None, description="Extraction mode: 'replace_fabricated' (default), 'extract_only', 'validate_existing'")
    output_format: Optional[str] = Field(default=None, description="Output format: 'csv', 'json', 'both' (default)")


class ExperimentalResultsExtractorTool(BaseTool):
    name: str = "experimental_results_extractor_tool"
    description: str = """
    ...
    """
    args_schema: Type[BaseModel] = ExperimentalResultsExtractorToolInput
    ...
    def _run(self, workspace_dir: str, extract_mode: Optional[str] = None,
        ...
        if extract_mode is None:
            extract_mode = "replace_fabricated"
