...
from consortium.toolkits.search.open_deep_search.context_scraping.extraction_result import (
    ExtractionResult,
    print_extraction_result,
)
from consortium.toolkits.search.open_deep_search.context_scraping.basic_web_scraper import (
    ExtractionConfig,
)
from consortium.toolkits.search.open_deep_search.context_scraping.strategy_factory import (
    StrategyFactory,
)
...
class WebScraper:
    ...
    async def scrape(self, url: str) -> Dict[str, ExtractionResult]:
        ...
        if "wikipedia.org/wiki/" in url:
            from consortium.toolkits.search.open_deep_search.context_scraping.utils import (
